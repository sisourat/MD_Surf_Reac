...
for ib, b in enumerate(mydyn.blist):
   zt_0_vect, vzt_0_vect = mydyn.initial_gen_target(mydyn.zt_i,mydyn.ekt_i,mysys.omega_a,mysys.mt,mydyn.ntraj)
   zp_0_vect, rho_0_vect, vzp_0_vect, vrho_0_vect = mydyn.initial_gen_proj(mydyn.zp_i,b,mydyn.theta,mydyn.ecoll
                                                    ,mydyn.delta_rho,mydyn.delta_ek,mysys.mp,mydyn.ntraj)
